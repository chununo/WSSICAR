...
{
    public function index(Request $request): ArticuloCollection
    {
        ...
        return new ArticuloCollection($articulos);
    }

    public function store(ArticuloStoreRequest $request): ArticuloResource
    {
		...
		return (new ArticuloResource($articulo))->additional([
			'status'   => $status,
			'warnings' => $errors,
		]);
    }
    ...
    public function update(ArticuloUpdateRequest $request, Articulo $articulo): ArticuloResource
    {
		$data = $request->validated();
